...
public class Constants {
    ...
    public static final short MASK_FURNITURE = CATEGORY_PLAYER | CATEGORY_FURNITURE;
    ...
    public static final float SCROLL_VELOCITY = -WORLD_HEIGHT/6;
    ...
    public static final float LAVA_PATCH_MIN_LENGTH = WORLD_HEIGHT/8;

    public static final float LAVA_GENERATION_PER_SECOND = 0.25f;
